...
namespace DRM.Migrations
{
    ...
    [Migration("20250424235614_Modifiyed")]
    partial class Modifiyed
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DRM.Data.ApplicationUser", b =>
                {
            ...
            modelBuilder.Entity("DRM.Models.Student", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("DRM.Data.ApplicationUser", null)
                        .WithMany()
